...
class EndNet(nn.Module):
    ...
    def forward(self, ori_x1, ori_x2):
        # print(ori_x1.shape)
        # print(ori_x2.shape)
        ori_x1 = ori_x1.reshape(ori_x1.shape[0], ori_x1.shape[2])
        ori_x2 = ori_x2.reshape(ori_x2.shape[0], ori_x2.shape[1])
        ...
        out = self.activation(
            self.joint_encoder_bn6(self.joint_encoder_fc6(joint_x)))
